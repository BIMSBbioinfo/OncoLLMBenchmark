# structure the treatment plan for the BRCA cases to extract the relevant information without changing the original text
...
## define the prompt to structure the treatment plan for the BRCA cases to extract the relevant information without changing the original text
...
#print("Max tokens set:", llm_claude35.model_kwargs.get("max_tokens", "Not Set"))

tqdm.pandas()

## load data
df = pd.read_csv("/brca_structured.csv")
...
df.to_csv("brca_ass_plan_structured.csv", index = False)